...
<body>
	...
	<div class="content-utama">
				...
				<?php
					...
					$kolom = 3;
					$i = 0;
					$sql = mysqli_query($kon,"SELECT * FROM keseniandaerah");
					...
					$i++;
				?>
				<h5><td><p align="center"><?php echo $data['namaKesenian']; ?><br>
				<img src="img/<?php echo $data['gambarkesenian'];?>" height="160" width="160" style="margin:5px;"/><br>
				Keterangan : <?php echo $data['keterangankesenian']; ?><br>
				</h5></p></td>
				<?php
					}
						?>
